...
for f in .htaccess index.html url2pub.html url2pub.php config.php auth_common.php lib.php ajax.php reward-worker.php history.php robots.txt sitemap.xml \
